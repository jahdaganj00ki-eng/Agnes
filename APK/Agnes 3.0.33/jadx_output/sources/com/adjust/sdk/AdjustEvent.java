...
public class AdjustEvent {
    ...
    private boolean checkRevenue(Double d5, String str) {
        if (d5 == null) {
            if (str == null) {
                return true;
            }
        ...
        if (d5.doubleValue() < 0.0d) {
            logger.error("Invalid amount %.5f", d5);
            return false;
        }
        if (str == null) {
    ...
    public void setRevenue(double d5, String str) {
        if (checkRevenue(Double.valueOf(d5), str)) {
