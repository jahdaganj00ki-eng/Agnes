...
public class Reflection {
    ...
    public static LicenseData getLicenseRequiredData(Context context, ILogger iLogger, long j4) {
        try {
            return (LicenseData) invokeStaticMethod("com.adjust.sdk.google.lvl.Util", "getLicenseRequiredData", new Class[]{Context.class, ILogger.class, Long.TYPE}, context, iLogger, Long.valueOf(j4));
        } catch (Exception unused) {
            return null;
        }
    }
