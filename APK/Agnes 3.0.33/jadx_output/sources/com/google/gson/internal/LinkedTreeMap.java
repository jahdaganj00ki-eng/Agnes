...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private void rebalance(Node<K, V> node, boolean z2) {
        while (node != null) {
            ...
            int i6 = node2 != null ? node2.height : 0;
    ...
    public Node<K, V> find(K k, boolean z2) {
        int iCompareTo;
        Node<K, V> node;
    ...
    public void removeInternal(Node<K, V> node, boolean z2) {
        ...
        nodeLast.height = Math.max(i6, i10) + 1;
    ...
    public static final class Node<K, V> implements Map.Entry<K, V> {
        ...
        public Node(boolean z2, Node<K, V> node, K k, Node<K, V> node2, Node<K, V> node3) {
            this.parent = node;
            this.key = k;
            this.allowNullValue = z2;
            this.height = 1;
